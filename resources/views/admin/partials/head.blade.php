  ...
  <head>
    ...
    <link
      rel="stylesheet"
      href="{{asset('assets/vendor/ti-icons/css/themify-icons.css')}}"
    />
    ...
    <link
      ...
      href="{{asset('assets/vendor/ti-icons/css/themify-icons.css')}}"
    />
    <script src="https://code.jquery.com/jquery-3.7.1.min.js" integrity="sha256-7r6E6F0iAfDdc/K1Ji/7luWGINuDhcE7AT5EKeos4X4=" crossorigin="anonymous"></script>
